...
public class Github {
    ...
    private static final String GITHUB_LATEST = "https://github.com/moli884311/webhtv/releases/latest/download";
    private static final String GITHUB_RELEASE = "https://github.com/moli884311/webhtv/releases/download";
    private static final String GITHUB_UPDATE_CHANNEL = GITHUB_RELEASE + "/update-channel";
    private static final String CNB_MANIFEST = "https://tvbox.moliys.icu/apk";
    private static final String GITHUB_API = "https://api.github.com/repos/moli884311/webhtv/releases/tags";
    private static final String GITHUB_RELEASES_API = "https://api.github.com/repos/moli884311/webhtv/releases";
    private static final String GITHUB_RELEASE_ASSETS_API = "https://api.github.com/repos/moli884311/webhtv/releases/assets";
